...
public class Login extends javax.swing.JFrame {
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        ...
        Pessoa investidor = CadastroCorreto.dadosCadastroPessoa(cpf, senha);
        if(investidor.getCpf().equals(cpf) && investidor.getSenha().equals(senha)){
            JOptionPane.showMessageDialog(Login.this, "Login");
        } else{
            JOptionPane.showMessageDialog(Login.this, "Falha");
        }
